...
import type { SlidevMarkdown } from '@smslidev/types'

import { parse } from '@smslidev/parser'
import Cover from '@slidev/theme-default/layouts/cover.vue'
import Default from '@smslidev/client/layouts/default.vue'
import Center from '@smslidev/client/layouts/center.vue'
import SlideContainer from '@smslidev/client/internals/SlideContainer.vue'
import '@smslidev/client/styles/layouts-base.css'
