...
import type { ResolvedSlidevOptions, SlidevConfig, SlidevData, SlidevPreparserExtension } from '@smslidev/types'
import equal from 'fast-deep-equal'
import { verifyConfig } from '@smslidev/parser'
import { injectPreparserExtensionLoader } from '@smslidev/parser/fs'
